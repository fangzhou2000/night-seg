...
PIPLINES = Registry('pipline')

def _concat_dataset(cfg, default_args=None):
    """Build :obj:`ConcatDataset by."""
    from .dataset_warppers import ConcatDataset
    img_dir = cfg['img_dir']
...
# my-dafomer new added
def build_dataset(cfg, default_args=None):
    """Build datasets."""
    from .dataset_warppers import (ConcatDataset, MultiImageMixDataset,
                                  RepeatDataset)
